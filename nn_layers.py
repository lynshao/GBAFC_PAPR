...
class BERT(nn.Module):
    def __init__(self, mod, input_size, m, d_model, N, heads, dropout, custom_attn=True, multclass = False, NS_model=0, isrelu=1):
        super(BERT, self).__init__()
        self.mod = mod
        self.multclass = multclass
        self.m = m
        self.encoder = Encoder(mod, d_model, N, heads, dropout, input_size, custom_attn, NS_model, isrelu)
        if mod == "trx":
...
class Encoder(nn.Module):
    def __init__(self, mod, d_model, N, heads, dropout, input_size, customAttn= True, NS_model = 0, isrelu = 1):
        ...
        self.fe = FE(mod, NS_model, input_size, d_model, isrelu)
    def forward(self, src, mask, pe):
